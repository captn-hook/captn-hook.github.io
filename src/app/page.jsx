  ...
  return (
    <>
      ...
      <main className={styles.main} id="Main">
        ...
        <p className={styles.description + " " + styles.thin + " " + styles.snapper}>
        ...
        <h3 className={styles.title}>Here are some of my favorite projects:</h3>
        ...
        <iframe className={styles.viewer} src="https://view.poppy.com/embed/" title="3D Viewer" id="Sample Projects"/>
        <p className={styles.description}>
        ...
        <iframe className={styles.resume + " " + styles.snapper} src="/Resume.pdf#toolbar=0#view=Fit" title="Resume" id="Resume" />
        <p className={styles.description} id="Github">
          Below are some of my favorite Github projects:
        </p>
        <ul className={styles.cardList + " " + styles.snapper}>
          {repos.map((repo) => (
            <li key={repo}>
        ...
        />
        <footer className={styles.footer + " " + styles.snapper}>
